package com.enterprise.marketplace.aiservice.security;
    ...
    SecurityFilterChain aiSecurityFilterChain(
        ...
        if (securityEnabled) {
            http.authorizeHttpRequests(auth -> auth.requestMatchers(
                            ...
                            .permitAll()
                            .requestMatchers(HttpMethod.POST, "/api/v1/ai/chat", "/api/v1/ai/search/interpret")
                            .hasAnyRole(
                                    MarketplaceRoles.BUYER,
                                    MarketplaceRoles.SELLER,
                                    MarketplaceRoles.ADMIN)
                            .requestMatchers(HttpMethod.GET, "/api/v1/ai/recommendations")
                            .hasAnyRole(
                                    MarketplaceRoles.BUYER,
                                    MarketplaceRoles.SELLER,
                                    MarketplaceRoles.ADMIN)
                            .requestMatchers(HttpMethod.POST, "/api/v1/ai/generate/**")
