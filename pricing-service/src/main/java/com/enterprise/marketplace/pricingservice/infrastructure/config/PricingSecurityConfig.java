package com.enterprise.marketplace.pricingservice.infrastructure.config;
...
public class PricingSecurityConfig {
    ...
    @Bean
    SecurityFilterChain pricingSecurityFilterChain(
        ...
        if (securityEnabled) {
            http.authorizeHttpRequests(auth -> auth.requestMatchers(
                                    ...
                                    "/api/v1/bootstrap/**")
                            .permitAll()
                            .requestMatchers(org.springframework.http.HttpMethod.GET, "/api/v1/pricing/**")
                            .permitAll()
