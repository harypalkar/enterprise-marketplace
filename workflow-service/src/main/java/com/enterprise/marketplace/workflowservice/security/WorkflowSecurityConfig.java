package com.enterprise.marketplace.workflowservice.security;
...
public class WorkflowSecurityConfig {
    ...
    @Bean
    SecurityFilterChain workflowSecurityFilterChain(
        ...
        if (securityEnabled) {
            http.authorizeHttpRequests(auth -> auth.requestMatchers(
                                    ...
                                    "/api/v1/bootstrap/**")
                            .permitAll()
                            .requestMatchers(org.springframework.http.HttpMethod.GET, "/api/v1/workflows/**")
                            .permitAll()
                            .requestMatchers("/api/v1/workflows/**")
